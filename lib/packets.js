...
var GetAvailableQueuesPacket = function() {
	Packet.apply(this, arguments);
};

GetAvailableQueuesPacket.prototype.constructor = Packet;

GetAvailableQueuesPacket.prototype.generate = function() {
	var object = new ASObject();
	object.name = 'flex.messaging.messages.RemotingMessage';
	object.keys = ['source', 'operation', 'timestamp', 'messageId', 'clientId', 'timeToLive', 'body', 'destination', 'headers'];
	object.object = {
...
GetAvailableQueuesPacket.prototype.generateHeaders = function() {
	var headers = new ASObject();
	headers.name = '';
	headers.object = {
		DSId: this.options.dsid,
...
var GetChallengerLeaguePacket = function() {
	Packet.apply(this, arguments);
};

GetChallengerLeaguePacket.prototype.constructor = Packet;

GetChallengerLeaguePacket.prototype.generate = function(queueType) {
	var object = new ASObject();
	object.name = 'flex.messaging.messages.RemotingMessage';
	object.keys = ['source', 'operation', 'timestamp', 'messageId', 'clientId', 'timeToLive', 'body', 'destination', 'headers'];
	object.object = {
		operation: 'getChallengerLeague',
		source: null,
		timestamp: 0,
		clientId: this.options.clientId,
		timeToLive: 0,
...
GetChallengerLeaguePacket.prototype.generateHeaders = function() {
	var headers = new ASObject();
	headers.name = '';
	headers.object = {
		DSId: this.options.dsid,
  ...
  exports.GetAvailableQueuesPacket = GetAvailableQueuesPacket;
  exports.GetChallengerLeaguePacket = GetChallengerLeaguePacket;
